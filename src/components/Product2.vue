<template>
  <div class="gray-bg marginTop">
                  ...
                  <tr>
                    <td style="width: 40%;">
                      <div class="form-group" style="padding-top:5px;">
                        ...
                        <div class="col-sm-6">
                          <input type="text" v-model="searchParams.productCode" placeholder="" class="form-control" maxlength="11">
                        </div>
                      </div>
                    </td>
                    <td style="width: 40%;">
                      <div class="form-group" style="padding-top:5px;">
                        ...
                        <div class="col-sm-6">
                          <input type="text" v-model="searchParams.productName" placeholder="" class="form-control" maxlength="11">
                        </div>
                      </div>
                    </td>
              ...
              <div class="form-group formGroup">
                <div class="col-sm-12" style="margin-left: -4.5%;margin-bottom: 10px">
                  ...
                  <div class="col-sm-8">
                    ...
                    <label class="select_label2"><input type="checkbox" name="info" value="8" id="info_8" />联系人信息</label>
                    <label class="select_label2"><input type="checkbox" name="info" value="9" id="info_9" />工作人员填写</label>
                  </div>
    ...
    <div class="wrapper wrapper-content animated fadeInRight" tabindex="-1" id="win" :class="[showParams.modalShow ? showParams.devStyle : showParams.winShow]">
    ...
    methods : {
     ...
     initEqualType: function () {
      ...
      clearWin : function () {
        ...
        $("#productTypeDiv").find(".select2-chosen").eq(2).text("")
        vm.params.repayType = ""
        $("#repayTypeDiv").find(".select2-chosen").eq(2).text("")
